                  ...
                  <div className="row g-0 align-items-stretch">
                    ...
                    <div className="col-lg-6 d-none d-lg-block p-relative">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url('https://images.pexels.com/photos/3278215/pexels-photo-3278215.jpeg?auto=compress&cs=tinysrgb&w=1000')",
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            background:
                              "linear-gradient(180deg, rgba(10, 37, 64, 0.15) 0%, rgba(10, 37, 64, 0.55) 100%)",
                          }}
                        />
                      </div>
                    </div>
                          ...
                          <form onSubmit={handleSubmit}>
                            <div className="tp-login-input-wrapper tp-contact-form">
                              <div className="tp-review-input mb-15">
                                <label className="tp-label mb-5" htmlFor="name" style={{ fontSize: "13px" }}>
                                  Full Name
                                </label>
                                <input
                                  className="tp-input"
                            ...
                            <div className="tp-review-input d-flex align-items-start mb-20">
                              <input
                                ...
                                required
                              />
                              <label className="tp-agree mb-0" htmlFor="agree" style={{ cursor: "pointer", fontSize: "12.5px" }}>
