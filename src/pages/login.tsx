              ...
              <div className="col-xl-6 col-lg-8">
                <div className="tp-login-wrapper">
                  ...
                  <div className="tp-login-top text-center mb-30">
                    <h3 className="tp-login-title">Sign In to Your Account</h3>
                    <p>
                  ...
                  <div className="tp-login-option">
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-30">
                        <div className="tp-review-input d-flex align-items-start">
                          <input
                          ...
                          />
                          <label className="tp-agree" htmlFor="rememberMe" style={{ cursor: "pointer" }}>
                            Remember me
                          </label>
                        </div>
